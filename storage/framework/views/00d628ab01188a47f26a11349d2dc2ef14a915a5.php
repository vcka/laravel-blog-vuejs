            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="box-tools">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('page.create', Auth::user())): ?>
...
var gridOptions = {
    url: "<?php echo e(route('page.data')); ?>",
    colNames: ["SNo.", "Label", "Name", "Created At", "Edit", "Delete"],
    colModel: [
