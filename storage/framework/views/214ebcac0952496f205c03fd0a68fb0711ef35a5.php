            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="box-tools">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user.create', Auth::user())): ?>
                            <a class='col-lg-offset-0 btn btn-success' href="<?php echo e(route('user.create')); ?>">Add New</a>
                            <?php endif; ?>
...
var gridOptions = {
    ...
    colNames: ["SNo.", "Name", "Email", "Created At", "Edit", "Delete"],
    colModel: [
