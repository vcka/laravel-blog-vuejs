            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="box-tools">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('tag.create', Auth::user())): ?>
                            <a class='col-lg-offset-0 btn btn-success' href="<?php echo e(route('tag.create')); ?>">Add New</a>
                            <?php endif; ?>
