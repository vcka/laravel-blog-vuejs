    ...
    <section class="content">
        <div class="box box-danger collapsed-box">
            ...
            <div class="box-body" style="display: none">
                <div class="row">
                    <div class="col-xs-3">
                        <input type="text" class="form-control" name="search_title" id="search_title" placeholder="Comment" value="">
                    </div>                    
                    <div class="col-xs-3">
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="box-tools">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('role.create', Auth::user())): ?>
...
var gridOptions = {
    ...
    colNames: ["SNo.", "Name", "Created At", "Edit", 'Delete'],
    colModel: [
