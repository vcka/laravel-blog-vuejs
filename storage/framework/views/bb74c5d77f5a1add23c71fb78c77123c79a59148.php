            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="box-tools">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('comment.create', Auth::user())): ?>
                            <a class='col-lg-offset-0 btn btn-success' href="<?php echo e(route('comment.create')); ?>">Add New</a>
                            <?php endif; ?>
...
var gridOptions = {
    url: "<?php echo e(route('comment.data')); ?>",
    colNames: ["SNo.", "Name", "Email", "Comment","Created At", "Status"],
    colModel: [
